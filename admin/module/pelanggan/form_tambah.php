          ...
          <div class="animated fadeIn">
            <div class="card">
                  <div class="card-header">
                     <strong>Add</strong> Pelanggan</div>
                  <div class="card-body">
                    <form class="form-horizontal" action="../admin/module/pelanggan/aksi_simpan.php" method="post">
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="text" class="form-control" id="nama_pelanggan" name="P_user" placeholder="Username">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="password" class="form-control" id="password" name="P_password" placeholder="Password">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="text" class="form-control" id="nama_pelanggan" name="P_nama_lengkap" placeholder="nama">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="alamat" class="form-control" id="alamat" name="P_alamat" placeholder="alamat">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="email" class="form-control" id="email" name="P_email" placeholder="email">
