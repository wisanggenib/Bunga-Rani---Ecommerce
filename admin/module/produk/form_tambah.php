        ...
        <div class="container-fluid">
          <div class="animated fadeIn">
            <div class="card">
                  ...
                  <div class="card-body">
                    <form class="form-horizontal" action="../admin/module/produk/aksi_simpan.php" method="post">
                      <div class="form-group row">
                        <label class="col-md-3 col-form-label" for="hf-email">Bunga</label>
                        <div class="col-md-9">
                          <input type="text" class="form-control" id="bunga" name="bunga" placeholder="Jenis Bunga">
